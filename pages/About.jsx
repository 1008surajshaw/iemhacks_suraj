...
import StatusComponent from '../components/core/AboutPage/StatusComponents'
//import HighlightText from '../components/core/Homepage/HighlightText'
      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                ...
                <HighlightText text={"Bringht Future"}/>
                <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">Studynotion is at the forefront of driving 
