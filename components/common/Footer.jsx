...
// Images
import Logo from "../../assets/Logo/ssproject.png";
...
const Footer = () => {
  return (
    <div className='bg-richblack-800'>
            ...
            <div className='border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700'>
                ...
                <div className='lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3'>
                    ...
                    <div className='w-[48%] lg:w-[30%] mb-7 lg:pl-0'>
                      ...
                      <div className='fleex flex-col gap-2 mt-2'>
        ...
        <div className='flex flex-row item-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm '>
            ...
            <div className='flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full'>
                ...
                <div className='text-center' >Made by suraj and rajesh  © 2023 Scholar sync</div>
            </div>
        </div>
